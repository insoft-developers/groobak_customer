...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText phone, nama, kota, email, password, numOne, numTwo, numThree, numFour, numFive, numSix;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (TextUtils.isEmpty(kota.getText().toString())) {

                    notif("kota tidak boleh kosong");
...
//sendcode-----------------------
    ...
    private void upload(final String check) {
        ...
        request.setKota(kota.getText().toString());
